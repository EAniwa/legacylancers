...
// const calendarRoutes = require('./routes/api/calendar'); // Disabled due to middleware issues
...
// app.use('/api/calendar', calendarRoutes); // Disabled due to middleware issues
